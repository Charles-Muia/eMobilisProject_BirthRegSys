...
?>
    ...
    <main class="wrapper">
        ...
        <form class="input" action="System/signup.code.php" method="post"><br>
            <span> * </span>
            ...
            <span> * </span>
            <input type="password" size="25" name="userpass" placeholder="Password"> <br>
            <span> * </span>
            <input type="password" size="25" name="usercpass" placeholder="Confirm Password"><br>
            <br>
            <button class="button3" type="submit" name="signup-press">Click to Register / Signup</button>
            <br>
